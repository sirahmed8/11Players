...
export function getSkeletonVariantForPath(pathname: string): SkeletonVariant {
  ...
  if (pathname.startsWith("/analytics") || pathname.startsWith("/leaderboard") || pathname.startsWith("/stats")) return "stats";
  ...
  if (pathname.startsWith("/support") || pathname.startsWith("/inbox")) return "inbox";
  if (pathname.startsWith("/pro-pass")) return "ceremony";
