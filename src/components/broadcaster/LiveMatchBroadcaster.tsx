...
export const INITIAL_MATCH_EVENTS: BroadcasterEvent[] = [
  {
    ...
    type: 'KEY_SAVE',
    team: 'teamA',
    description: 'Yassine Bounou produces a brilliant diving save!',
    commentaryAr: 'تصدى حارس المرمى ياسين بونو لقبلة الهجمة براعة فائقة!',
  ...
  },
  {
    ...
    type: 'GOAL',
    team: 'teamA',
    description: 'GOAL! Achraf Hakimi fires a rocket into the top right corner!',
    commentaryAr: 'هدف! اشرف حكيمي يطلق قذيفة صاروخية في الشباك!',
