              ...
              <div className="space-y-5">
                <div className="grid grid-cols-1 sm:grid-cols-2 gap-4">
                  ...
                  <div className="relative" ref={timePickerRef}>
                    ...
                    {/* Time Dropdown - Right aligned so it never overflows off screen */}
                    <AnimatePresence>
                      {showTimePicker && (
                        <motion.div
                          initial={{ opacity: 0, y: -8, scale: 0.98 }}
                                ...
                                <button
                                  ...
                                  className={`px-2 py-1.5 rounded-xl text-xs font-bold transition-all ${
                                    config.time === t
                                      ...
                                      : "bg-slate-50 dark:bg-slate-700/60 hover:bg-slate-100 dark:hover:bg-slate-700 text-slate-700 dark:text-slate-300"
                                  }`}
                                >
                                  {t}
                                </button>
