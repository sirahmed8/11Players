            ...
            {result.tipsAndTactics?.teamA && (
              <div className="mb-8 p-4 bg-blue-50 dark:bg-blue-900/20 border border-blue-100 dark:border-blue-800/30 rounded-xl">
                <p className="text-blue-800 dark:text-blue-200 font-medium leading-relaxed">
                  ...
                  {locale === 'ar' ? (result.tipsAndTactics.teamA_Ar || "👔 ملخص تعليمات المدرب: الحفاظ على الانضباط التكتيكي والتقارب بين الخطوط والاعتماد على اللعب الجماعي وسرعة التحول الهجومي واستغلال المساحات لحسم نتيجة اللقاء.") : result.tipsAndTactics.teamA}
                </p>
              </div>
            )}
            ...
            {result.tipsAndTactics?.teamB && (
              <div className="mb-8 p-4 bg-red-50 dark:bg-red-900/20 border border-red-100 dark:border-red-800/30 rounded-xl">
                <p className="text-red-800 dark:text-red-200 font-medium leading-relaxed">
                  ...
                  {locale === 'ar' ? (result.tipsAndTactics.teamB_Ar || "👔 ملخص تعليمات المدرب: الحفاظ على الانضباط التكتيكي والتقارب بين الخطوط والاعتماد على اللعب الجماعي وسرعة التحول الهجومي واستغلال المساحات لحسم نتيجة اللقاء.") : result.tipsAndTactics.teamB}
                </p>
              </div>
            )}
