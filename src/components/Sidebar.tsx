...
export default function Sidebar() {
  ...
  return (
    <>
      ...
      {/* Sidebar Content */}
      <div
        className={`fixed md:sticky top-0 left-0 h-screen w-72 bg-white/95 dark:bg-slate-900/95 backdrop-blur-xl border-r border-slate-200 dark:border-slate-800 z-50 transform transition-transform duration-300 ease-in-out flex flex-col ${
          isOpen ? "translate-x-0" : "-translate-x-full md:translate-x-0"
        } ${isAr ? "right-0 left-auto border-r-0 border-l" : ""}`}
      >
