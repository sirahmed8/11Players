...
export const PLAYER_STYLES = [
  ...
  { id: 'deep_lying_forward', en: 'Deep-Lying Forward', ar: 'مهاجم متأخر', descEn: 'Drops back to receive the ball and create chances.', descAr: 'يتراجع لاستلام الكرة وصناعة الفرص.', positions: ['CF', 'SS'] },
  { id: 'dummy_runner', en: 'Dummy Runner', ar: 'عداء وهمي', descEn: 'Makes decoy runs to draw defenders away.', descAr: 'يقوم بانطلاقات وهمية لسحب المدافعين.', positions: ['CF', 'SS', 'AMF'] },
  ...
  { id: 'roaming_flank', en: 'Roaming Flank', ar: 'جناح متجول', descEn: 'Cuts inside from the wing to receive passes.', descAr: 'يخترق من الجناح للعمق لاستلام التمريرات.', positions: ['LWF', 'RWF', 'LMF', 'RMF'] },
  { id: 'cross_specialist', en: 'Cross Specialist', ar: 'متخصص عرضيات', descEn: 'Stays wide to deliver crosses into the box.', descAr: 'يبقى على الأطراف لإرسال العرضيات.', positions: ['LWF', 'RWF', 'LMF', 'RMF'] },
  ...
  { id: 'the_destroyer', en: 'The Destroyer', ar: 'المدمر', descEn: 'A tenacious tackler who stops attacks.', descAr: 'مدافع شرس يوقف هجمات الخصم.', positions: ['DMF', 'CMF', 'CB'] },
  ...
  { id: 'extra_frontman', en: 'Extra Frontman', ar: 'مهاجم إضافي', descEn: 'Defender who occasionally joins the attack.', descAr: 'مدافع ينضم أحياناً للهجوم.', positions: ['CB'] },
  ...
  { id: 'fullback_finisher', en: 'Full-back Finisher', ar: 'ظهير هداف', descEn: 'Full-back who cuts centrally to attack the box.', descAr: 'ظهير يدخل للعمق لمهاجمة منطقة الجزاء.', positions: ['LB', 'RB'] },
