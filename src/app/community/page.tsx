        ...
        <main className="max-w-7xl mx-auto px-4 py-8">
          <div className="flex flex-col md:flex-row justify-between items-end mb-8 gap-4">
            ...
            <div className="flex gap-4 w-full md:w-auto">
              <div className="relative w-full md:w-64 flex items-center bg-white dark:bg-slate-800/80 border border-slate-200 dark:border-slate-700 rounded-2xl transition-all duration-300 focus-within:border-emerald-500 dark:focus-within:border-emerald-500 focus-within:ring-2 focus-within:ring-emerald-500/50 shadow-sm focus-within:shadow-md group">
                <Search className="absolute left-3.5 rtl:left-auto rtl:right-3.5 w-4 h-4 text-slate-400 pointer-events-none transition-colors duration-300 group-focus-within:text-emerald-500" />
                <input
                  type="text"
