      ...
      <ProtectedRoute requireCommunity>
        <div className="min-h-screen bg-slate-950 text-white flex items-center justify-center p-8">
          <div className="flex items-center gap-3 bg-slate-900 px-6 py-4 rounded-2xl border border-slate-800 shadow-xl">
            ...
            <span className="text-sm font-bold text-slate-300">Loading Community Squad...</span>
          </div>
        </div>
      </ProtectedRoute>
    );
              ...
              <div className="flex items-center gap-2 min-w-max w-full">
                ...
                <button
                  onClick={() => {
                    ...
                    const url = `${window.location.origin}/c/${(activeCommunity as any)?.joinCode || (activeCommunity as any)?.code || activeCommunityId}`;
            ...
            <div className="flex flex-col sm:flex-row gap-2.5 w-full md:w-auto items-stretch sm:items-center">
              ...
              <div className="relative flex-1 md:w-64">
                ...
                <input
                  ...
                  className="w-full pl-10 pr-4 rtl:pr-10 rtl:pl-4 py-2.5 bg-slate-900/80 border border-slate-800 focus:ring-2 focus:ring-emerald-500/30 focus:border-emerald-500 rounded-xl outline-none transition-all duration-300 text-sm font-bold text-white placeholder-slate-500 shadow-sm"
                />
              </div>
