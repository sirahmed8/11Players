        ...
        <div className="max-w-6xl mx-auto px-4 sm:px-8 pt-8">
          <div className="bg-gradient-to-br from-amber-600 to-amber-700 rounded-3xl shadow-2xl shadow-amber-500/30 border-2 border-amber-400/30 p-8 sm:p-12 relative overflow-hidden">
            ...
            <div className="relative z-10 flex flex-col lg:flex-row items-center justify-between gap-6">
              <div className="text-center lg:text-start space-y-4 max-w-xl lg:max-w-2xl">
                ...
                <h1 className="text-2xl sm:text-4xl lg:text-5xl font-black text-white tracking-tight flex items-center justify-center lg:justify-start gap-3 flex-wrap">
              ...
              {isAdmin && (
                ...
                >
                  <button
                    ...
                    className="w-full sm:w-auto px-6 py-3.5 sm:px-8 sm:py-4 rounded-2xl bg-white hover:bg-amber-50 text-amber-700 font-black text-sm sm:text-base shadow-xl shadow-black/20 flex items-center justify-center gap-2.5 transition-all border-2 border-amber-300 whitespace-normal sm:whitespace-nowrap text-center"
                  >
